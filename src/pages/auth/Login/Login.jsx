...
const Login = () => {
    return (
        <div className="hero min-h-screen pt-14 pb-36">
            <div className="hero-content flex-col lg:flex-row gap-20">
                <div className="w-1/2 ">
                    <img src={img} alt="" />
                </div>
                <div className="card w-1/2 shrink-0 px-20 border-2 border-[#D0D0D0]">
                    <form className="w-[350px]">
                        ...
                        <div className="form-control">
                            ...
                            <input type="password" placeholder="Your password" className="input input-bordered bg-white" required />
                        </div>
                        ...
                        <h4 className='text-[#737373] text-lg font-normal text-center pt-8 pb-10'>Don't have an account? <span className='text-[#FF3811] font-bold'>Sign In</span></h4>
                    </form>
                </div>
            </div>
        </div>

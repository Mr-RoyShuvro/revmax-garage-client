    ...
    return (
        <div className='relative flex'>
            ...
            <div className='absolute bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] w-full h-full rounded-xl'>
                <h3 className='text-3xl md:text-5xl font-bold text-white pl-3 md:pl-28 pt-1 md:pt-32'>Booking</h3>
                <div
                ...
                >
                    ...
                    >
                        <h2 className='text-xl font-medium pt-3 md:pt-[101px]'>Booking</h2>
                    </div>
                </div>
